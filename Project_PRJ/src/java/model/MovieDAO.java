...
public class MovieDAO {
    ...
    public ArrayList<MovieDTO> getAllMovie() {
        ...
        try ( Connection conn = DBUtils.getConnection();  PreparedStatement stm = conn.prepareStatement(GET_ALL_MOVIE)) {
    ...
    public ArrayList<MovieDTO> getActiveMovie() {
        ArrayList<MovieDTO> list = new ArrayList<>();
        try ( Connection conn = DBUtils.getConnection();  PreparedStatement stm = conn.prepareStatement(GET_ACTIVE_MOVIE)) {
            try ( ResultSet rs = stm.executeQuery()) {
                while (rs.next()) {
                    int movieID = rs.getInt("movieID");
                    String title = rs.getString("title");
    ...
    public boolean deleteMovie(int movieID) {
        boolean check = false;
        try ( Connection conn = DBUtils.getConnection();  PreparedStatement stm = conn.prepareStatement(DELETE_MOVIE)) {
    ...
    public boolean updateMovie(MovieDTO movie) {
        ...
        try ( Connection conn = DBUtils.getConnection();  PreparedStatement stm = conn.prepareStatement(UPDATE_MOVIE)) {
            stm.setString(1, movie.getTitle());
            stm.setString(2, movie.getDescription());
            stm.setString(3, movie.getPosterUrl());
            stm.setString(4, movie.getGenre());
