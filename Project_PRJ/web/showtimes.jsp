...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            /* --- Phong cách nhóm theo Ngày (Chuyên nghiệp) --- */
            .date-group {
                margin-bottom: 35px;
            }
            .date-divider {
            ...
            /* --- Phong cách Thẻ Suất Chiếu mới (Professional ST-Card) --- */
            .st-card {
                display: block;
            ...
            /* Phủ màu nền cyan khi hover mà không cần đổi màu text của từng div */
            .st-card::before {
                content: '';
            ...
            /* Đảm bảo nội dung nằm trên lớp nền hover */
            .st-card-content {
    ...
    <body>
        <div class="container">
            <a href="welcome.jsp" class="btn-back"><i class="fas fa-arrow-left me-2"></i>Quay lại Trang Chủ</a>
            ...
            <div class="container-box">
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <c:set var="prevDate" value="" /> <c:forEach var="st" items="${SHOWTIME_LIST}" varStatus="status">
                            ...
                            <c:if test="${st.showDate != prevDate}">
                                ...
                                <div class="date-group">
                                    ...
                                    <div class="showtime-grid"> <c:set var="prevDate" value="${st.showDate}" /> </c:if>
